...
I'm a reporter with the Howard Center for Investigative Journalism, requesting bulk court data access (please see attached for a list of requested variables). 
...
Please note we may need a customized access level to be able to view the data in bulk as requested.
