...
I'm a reporter with the Howard Center for Investigative Journalism, requesting bulk court data access. 
...
Please note we may need a customized access level to be able to view the data in bulk as requested (please see attached list of requested variables).
