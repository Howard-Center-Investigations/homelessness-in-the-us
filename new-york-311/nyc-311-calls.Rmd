...
#load in all year-by-year files and put in list
require(data.table)
folder <- "C:/Users/TDiff/GitHub/homelessness-in-the-us/new-york-311/"
files = list.files(path = folder, pattern = '20[0-9]{2}-NYC-311-Service-Requests.Rds$')
all_calls_years <- lapply(file.path(folder, files), function (x) data.table(readRDS(x)))

#go through each year and analyze following info
for (sheet in all_calls_years) {
  #Figure out the year
...
#analyze agencies
  agency_calls <- sheet %>%
    ...
    arrange(desc(count))
  print(agency_calls)
  assign(paste0("agency_calls", year),agency_calls)
...
#Get an overall view of what agencies handle what complaint_types
  ...
  assign(paste0("agency_complaints", year),agency_complaints)
  ...
  complaints <- sheet %>%
    ...
    arrange(desc(count))
  print(complaints)
  assign(paste0("complaints", year),complaints)
...
#get a count of all descriptor values
  descriptors <- sheet %>%
    ...
    arrange(desc(count))
  print(descriptors)
  assign(paste0("descriptors", year),descriptors)

#Check pairings of complaints and descriptors
  complaint_descriptor <- sheet %>%
    select(complaint_type, descriptor) %>%
    group_by(complaint_type, descriptor) %>%
    summarize(count = n())
  assign(paste0("complaint_descriptor", year),complaint_descriptor)
  ...
  resolutions <- sheet %>%
    ...
    summarize(count = n())
  assign(paste0("resolutions", year),resolutions)
...
#look only at resolutions pertaining to homelessness
  homeless_resolutions <- sheet %>%
    ...
    summarize(count = n())
  assign(paste0("homeless_resolutions", year),homeless_resolutions)
  ...
  #from what locations did calls come
   locations <- sheet %>%
    ...
    summarize(count = n()) %>%
    mutate(pct = round(count/sum(count) * 100,3))
  assign(paste0("locations", year),locations)
  
  #how many different locations were called
  total_locations <- locations %>%
    summarize(total = sum(count))
  assign(paste0("total_locations", year),total_locations)
...
#rough overall count of homeless calls
  ...
  assign(paste0("total_homeless_calls", year),total_homeless_calls)
  
  #then get a list of all the data tables for each year
  year_all_sheets <- mget(ls(pattern = year))
  assign(paste0("all_", year, "_tables"), year_all_sheets, envir = parent.frame)
}
...
```{r}
#Load data
calls_2010 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2010-NYC-Service-Requests.Rds") 
```
...
#saveRDS(homeless_2010, "~/GitHub/homelessness-in-the-us/new-york-311/2010-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2011 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2011-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2011 <- calls_2011 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2011) %>%
...
#saveRDS(calls_2011, "~/GitHub/homelessness-in-the-us/new-york-311/2011-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2012 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2012-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2012 <- calls_2012 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2012) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2012, "~/GitHub/homelessness-in-the-us/new-york-311/2012-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2013 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2013-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2013 <- calls_2013 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2013) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2013, "~/GitHub/homelessness-in-the-us/new-york-311/2013-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2014 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2014-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2014 <- calls_2014 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2014) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2014, "~/GitHub/homelessness-in-the-us/new-york-311/2014-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2015 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2015-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2015 <- calls_2015 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2015) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2015, "~/GitHub/homelessness-in-the-us/new-york-311/2015-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2016 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2016-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2016 <- calls_2016 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2016) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2016, "~/GitHub/homelessness-in-the-us/new-york-311/2016-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2017 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2017-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2017 <- calls_2017 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2017) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2017, "~/GitHub/homelessness-in-the-us/new-york-311/2017-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2018 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2018-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2018 <- calls_2018 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2018) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2018, "~/GitHub/homelessness-in-the-us/new-york-311/2018-HOMELESS-NYC-Service-Requests.Rds")
...
```{r}
#Load data
calls_2019 <- readRDS("~/GitHub/homelessness-in-the-us/new-york-311/2019-NYC-Service-Requests.Rds")
```
...
descriptor_and_complaint_2019 <- calls_2019 %>%
  select(complaint_type, descriptor) %>%
  filter(descriptor %in% descriptor_list_2019) %>%
  group_by(descriptor, complaint_type) %>%
  summarize(count = n()) %>%
  mutate(pct = round(count/sum(count) * 100,3)) 
...
#saveRDS(calls_2019, "~/GitHub/homelessness-in-the-us/new-york-311/2019-HOMELESS-NYC-Service-Requests.Rds")
