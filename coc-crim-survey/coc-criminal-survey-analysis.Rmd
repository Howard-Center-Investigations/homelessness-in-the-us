...
states <- as.vector(crim_survey_states$state)
...
kable(alaska) %>%
  column_spec(2:ncol(alaska), border_left = T, border_right = T) %>%
...
kable(california) %>%
  column_spec (2:ncol(california),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
...
kable(dc) %>%
  column_spec (2:ncol(dc),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(florida) %>%
  column_spec (2:ncol(florida),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "500px")
```
...
kable(hawaii) %>%
  column_spec (2:ncol(hawaii),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(kentucky) %>%
  column_spec (2:ncol(kentucky),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(louisiana) %>%
  column_spec (2:ncol(louisiana),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(maryland) %>%
  column_spec (2:ncol(maryland),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(massachusetts) %>%
  column_spec (2:ncol(massachusetts),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(new_york) %>%
  column_spec (2:ncol(new_york),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(north_carolina) %>%
  column_spec (2:ncol(north_carolina),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
kable(oregon) %>%
  column_spec (2:ncol(oregon),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
```
...
* All the included Massachusetts laws are citywide
...
kable(all_state) %>%
  column_spec (2:ncol(all_state),border_left = T, border_right = T) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "250px")
