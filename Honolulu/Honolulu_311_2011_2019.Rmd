...
from the breakdown of counts per word pulled from the description column, terms that popped up were the following: 

- Homeless - common report type was homeless and a significant amount of other / some people spelled homeless wrong. They typed homless, categorized as other 
- Urinating/ feces- includes homeless/ camping- many are categorized as other 
- Congregating - homeless people, homeless campers, homeless squatters (2 are categorized as other report type )
- Encampment/ camping/ campsite/ campsites- many are categorized as homeless, some are categorized as other 
- (women/men/woman/women/sleeps/ sleeping - many are referring to homeless individuals, most are categorized as homeless or other 
